...
////// Emissive:
                ...
                float node_3878 = pow(1.0-max(0,dot(normalDirection, viewDirection)),_FresnelExponent);
                float3 emissive = ((_MainTex_var.rgb*i.vertexColor.rgb*_TintColor.rgb*2.0)*_TintColor.a*(1.0 - saturate((node_3878+_FresnelBoost))));
